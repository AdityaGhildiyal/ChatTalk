                  ...
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-y-scroll bg-[#202020] py-6 shadow-xl">
                      <div className="px-4 sm:px-6 flex justify-end">
                        <button
                          type="button"
                          className="rounded-md bg-[#303030] text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                          onClick={onClose}
                        >
                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6 flex flex-col items-center">
                        ...
                        <div className="mt-2 text-lg font-semibold text-neutral-100">{title}</div>
